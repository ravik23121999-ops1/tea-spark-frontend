...
const sidebarItems = [
    ...
    { name: 'Orders', icon: ClipboardList, href: '/admin/dashboard/orders' },
    { name: 'Products', icon: ShoppingCart, href: '/admin/dashboard/products' },
    { name: 'Categories', icon: Layers, href: '/admin/dashboard/categories' },
    { name: 'Staff Management', icon: Users, href: '/admin/dashboard/staff' },
];
                ...
                <div className="p-8">
                    <Link href="/" className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Manager</span>
                        </div>
                    </Link>
                </div>
            ...
            <main className="flex-1 flex flex-col min-w-0 lg:pl-72">
                ...
                <header className="h-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-4 md:px-8 flex items-center justify-between sticky top-0 z-[50]">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-secondary to-accent flex items-center justify-center text-white font-bold shadow-md">
                            A
                        </div>
                    </div>
                </header>
